...
public class program {
	public static void main(String[] args) {
		...
		DateTimeFormatter registroInicialFormatter = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm");
		System.out.println("Cronometro Iniciado! "
				+ "Horario de inicio: " + registroInicialFormatter.format(registroInicial));
		...
		DateTimeFormatter registroFinalFormatter = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm");
		System.out.println("Horario de encerramento: " + registroFinalFormatter.format(registroFinal));
